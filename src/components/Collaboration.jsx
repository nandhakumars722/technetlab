import { techNetSymbol, check, logo } from "../assets";
    ...
    <Section crosses>
      <div className="container lg:flex">
        <div className="max-w-[25rem]">
          <h2 className="h2 mb-4 md:mb-8">Our Values</h2>
        ...
        <div className="mt-4 lg:ml-auto xl:w-[48rem]">
          ...
          <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
            {/* <div className="flex w-60 aspect-square m-auto border border-n-6 rounded-full"> */}
              {/* <div className="w-[6rem] aspect-square m-auto p-[0.2rem] bg-conic-gradient rounded-full animate-pulse"> */}
                <div className="flex items-center aspect-square justify-center w-full h-full bg-conic-gradient bg-n-8 rounded-full animate-pulse">
                  <img
                    src={logo}
                    alt="TechNet logo"
                    width={320}
